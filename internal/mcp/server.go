...
func (s *Server) toolHandlers() map[string]handlerFn {
	return map[string]handlerFn{
		...
		"create_wifi_network":      s.toolCreateWiFiNetwork,
		"delete_wifi_network":      s.toolDeleteWiFiNetwork,
		"add_wifi_security":        s.toolAddWiFiSecurity,
		"remove_wifi_security":     s.toolRemoveWiFiSecurity,
		"add_wifi_datapath":        s.toolAddWiFiDatapath,
		"remove_wifi_datapath":     s.toolRemoveWiFiDatapath,
		"add_wifi_interface":       s.toolAddWiFiInterface,
		"remove_wifi_interface":    s.toolRemoveWiFiInterface,
		"add_wifi_provisioning":    s.toolAddWiFiProvisioning,
		"remove_wifi_provisioning": s.toolRemoveWiFiProvisioning,
		"provision_caps":           s.toolProvisionCAPs,
		// ── Bridges / VLANs ───────────────────────────────────────────────────
		"add_bridge":          s.toolAddBridge,
		"remove_bridge":       s.toolRemoveBridge,
		"add_bridge_port":     s.toolAddBridgePort,
		"remove_bridge_port":  s.toolRemoveBridgePort,
		"add_vlan":            s.toolAddVLAN,
		"remove_vlan":         s.toolRemoveVLAN,
		// ── IP / DHCP ─────────────────────────────────────────────────────────
		"add_ip_address":      s.toolAddIPAddress,
		"remove_ip_address":   s.toolRemoveIPAddress,
		"add_ip_pool":         s.toolAddIPPool,
		"remove_ip_pool":      s.toolRemoveIPPool,
		"add_dhcp_server":     s.toolAddDHCPServer,
		"remove_dhcp_server":  s.toolRemoveDHCPServer,
		"add_dhcp_network":    s.toolAddDHCPNetwork,
		"remove_dhcp_network": s.toolRemoveDHCPNetwork,
		"add_dhcp_lease":      s.toolAddDHCPLease,
		"remove_dhcp_lease":   s.toolRemoveDHCPLease,
		// ── DNS ───────────────────────────────────────────────────────────────
